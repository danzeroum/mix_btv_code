...
export const SCREEN_META: Record<ScreenId, ScreenMeta> = {
  ...
  ratelimit: { kicker: 'forge-llm', title: 'Rate limits', note: 'tetos configurados, não uso ao vivo', accent: 'var(--rust)', chromeIcon: '⏱', chromeRight: 'ratelimit' },
  ...
  lsp: { kicker: '.forge/lsp.toml', title: 'Language servers', note: 'declarado · lazy · zero probe', accent: 'var(--wire)', chromeIcon: '⌬', chromeRight: 'lsp' },
